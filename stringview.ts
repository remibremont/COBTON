...
|*|
|*|  Converted to TypeScript By Rémi Brémont 09/2016
|*|
\*/
export default class StringView {
  ...
  constructor (vInput : any, sEncoding? : string /* optional (default: UTF-8) */, nOffset? : number /* optional */, nLength? : number /* optional */) {
  ...
  static putUTF8CharCode(aTarget : any, nChar : number, nPutAt : number) {
  ...
  private static loadUTF8CharCode (aChars : any, nIdx : number) {
  ...
  private static getUTF8CharLength(nChar : number) {
    return nChar < 0x80 ? 1 : nChar < 0x800 ? 2 : nChar < 0x10000 ? 3 : nChar < 0x200000 ? 4 : nChar < 0x4000000 ? 5 : 6;
  }

  private static loadUTF16CharCode(aChars : any, nIdx : number) {
  ...
  private static putUTF16CharCode(aTarget : any, nChar : number, nPutAt : number) {
  ...
  private static getUTF16CharLength(nChar : number) {
...
/* Array of bytes to base64 string decoding */
  ...
  private static bytesToBase64(aBytes : any) {
  ...
  private static base64ToBytes(sBase64 : string, nBlockBytes? : number) : Uint8Array {
  ...
  private static makeFromBase64(sB64Inpt : string, sEncoding : string, nByteOffset : number, nLength : number) {
  ...
  private makeIndex(nChrLength? : number, nStartFrom? : number) {
  ...
  private toBase64(bWholeBuffer : boolean) {
  ...
  private subview(nCharOffset? : number /* optional */, nCharLength? : number /* optional */) {
  ...
  private forEachChar(fCallback : Function, oThat : Object, nChrOffset : number, nChrLen : number) {
