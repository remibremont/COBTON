...
export default class StringView {
            ...
            case 'object':
                /*classSwitch:*/ switch (vInput.constructor) {
                    ...
                    case Uint8Array:
                        ...
                        aWhole = vInput.byteOffset === 0 && vInput.length === (fTAView === Uint32Array ?
                            vInput.buffer.byteLength >>> 2
                            : fTAView === Uint16Array ?
                                vInput.buffer.byteLength >>> 1
                                :
                                    vInput.buffer.byteLength) ? vInput : new fTAView(vInput.buffer);
                        aRaw = nStartIdx === 0 && (!isFinite(nLength) || nLength === nInptLen) ?
                            vInput
    ...
    static putUTF8CharCode(aTarget, nChar, nPutAt) {
        ...
        if (nChar < 0x80 /* 128 */) {
            ...
            /* six bytes */
            aTarget[nIdx++] = 0xfc /* 252 */ + (nChar / 1073741824);
    ...
    toBase64(bWholeBuffer) {
        return StringView.bytesToBase64(bWholeBuffer ?
